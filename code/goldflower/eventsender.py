...
class TableEventSender:
    ...
    def send_player_kicked(self,kicker,player):
...
class GameEventSender:
    ...
    def send_show_hand(self,current_gambler,uid,gold):
    ...
    def send_game_over_event(self,winner,win_gold,fee_gold):
