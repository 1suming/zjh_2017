...
CHIPS = [100,200,500,800,1000,2000,5000,8000,10000,20000,50000,80000,100000,200000,500000,800000,1000000]
...
class Robot:
    ...
    def set_player_ready(self):
        ...
        req.body.table_id = self.table.id
    ...
    def handle_game_over_event(self,req):
        ...
        if self.same_table_games >= 6 and sum(self.game_results[-6:]) == 0:
            ...
            if not self.should_quit():
                gevent.spawn_later(random.randint(10,14),self.set_player_ready)
...
class RobotManager:
    def __init__(self,service):
        ...
        gevent.spawn(self.manage_robots)
        gevent.spawn(self.startup_robots)
