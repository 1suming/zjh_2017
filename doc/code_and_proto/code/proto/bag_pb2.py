...
_QUERYBAGRESP.fields_by_name['items'].message_type = struct__pb2._ITEM
_QUERYBAGRESP.fields_by_name['gifts'].message_type = struct__pb2._GIFT
_QUERYBAGRESP_DEF.containing_type = _QUERYBAGRESP
_USEITEMREQ_DEF.containing_type = _USEITEMREQ
_USEITEMRESP.fields_by_name['result'].message_type = struct__pb2._RESULT
